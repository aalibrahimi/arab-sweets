...
const MenuItem = ({ item }) => (
  ...
  >
    ...
    <p className="text-pink-600 dark:text-pink-400 font-bold">{item.price}</p>
...
export default function Menu() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-pink-100 to-yellow-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-500">
      {/* Navigation */}
      <nav className="bg-white dark:bg-gray-900 shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center">
            <ArrowLeft className="mr-2" size={20} />
            <span className="text-2xl font-bold text-pink-600 dark:text-pink-400">Back to Home</span>
          </Link>
      ...
      <section className="flex-grow py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center text-gray-800 dark:text-white mb-12">Our Menu</h1>
